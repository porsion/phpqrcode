...
class Porsion {
     ...
     */
	public static function getQRImg(String $str, int $size = null, String $logo = null, int $ret_type = null, String $out_file = null) {
		...
		$ret_qr = null; // 返回的QR定义
		// 定义一个临时文件
		$_tmp_dir = isset($_SERVER['TMPDIR']) && $_SERVER['TMPDIR'] ?   $_SERVER['TMPDIR'] :
            ( isset($_SERVER['TEMP']) && $_SERVER['TEMP'] ? $_SERVER['TEMP'] : '/tmp/' ) ; //临时文件目录
